<nav class="bg-white border-gray-200 dark:bg-gray-900 shadow-md">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
      ...
      <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Property Valuer</span>
    </a>
    ...
    <div class="flex items-center md:order-2 space-x-4 rtl:space-x-reverse">
      ...
      <div class="hidden md:flex">
        <ul class="flex space-x-8 rtl:space-x-reverse">
          ...
          <li><a href="#" class="text-gray-900 dark:text-white hover:text-blue-700">About</a></li>
          <li><a href="#" class="text-gray-900 dark:text-white hover:text-blue-700">Services</a></li>
          <li><a href="#" class="text-gray-900 dark:text-white hover:text-blue-700">Contact</a></li>
        </ul>
      </div>
